...
// CORS middleware configuration
const allowedOrigins = ["https://news-aggregators.vercel.app", "https://another-origin.com"];
app.use(
  cors({
    ...
    credentials: true, // Enable this if you are using cookies or other credentials
  })
);
